...
{
    /// <summary>
    /// Represents the request parameters for deleting a task link.
    /// All parameters are used in the query string.
    /// </summary>
    public class DeleteTaskLinkRequest
    {
        /// <summary>
        ...
        public DeleteTaskLinkRequest(bool? customTaskIds = null, string? teamId = null)
        {

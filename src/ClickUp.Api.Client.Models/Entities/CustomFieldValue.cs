...
namespace ClickUp.Api.Client.Models.Entities
{
    ...
    /// <param name="Type">The type of the custom field (e.g., "text", "number", "drop_down"). This might be redundant if <see cref="Id"/> is used to look up the full <see cref="ClickUp.Api.Client.Models.CustomFields.CustomFieldDefinition"/>.</param>

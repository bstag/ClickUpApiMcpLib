...
)
{
    ...
    /// </summary>
    /// <param name="NextCursor">NextCursor to retrieve the next page of messages. Null if no more pages.</param>
    /// <param name="PreviousCursor">NextCursor to retrieve the previous page of messages. Null if no previous page.</param>

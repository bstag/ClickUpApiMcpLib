...
public class FluentAddGuestToItemRequestTests
{
    ...
    public async Task AddAsync_TaskItemType_ShouldCallAddGuestToTaskAsync()
    {
        ...
        var fluentRequest = new FluentAddGuestToItemRequest(itemId, guestId, _mockGuestsService.Object, FluentAddGuestToItemRequest.ItemType.Task)
    ...
    public async Task AddAsync_ListItemType_ShouldCallAddGuestToListAsync()
    {
        ...
        var fluentRequest = new FluentAddGuestToItemRequest(itemId, guestId, _mockGuestsService.Object, FluentAddGuestToItemRequest.ItemType.List)
            .WithPermissionLevel(permissionLevel)
            .WithIncludeShared(includeShared);
    ...
    public async Task AddAsync_FolderItemType_ShouldCallAddGuestToFolderAsync()
    {
        ...
        var fluentRequest = new FluentAddGuestToItemRequest(itemId, guestId, _mockGuestsService.Object, FluentAddGuestToItemRequest.ItemType.Folder)
            .WithPermissionLevel(permissionLevel)
            .WithIncludeShared(includeShared);

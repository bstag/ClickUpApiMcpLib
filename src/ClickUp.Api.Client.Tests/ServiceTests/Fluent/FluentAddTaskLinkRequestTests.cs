    ...
    public class FluentAddTaskLinkRequestTests
    {
        ...
        public async Task AddAsync_ShouldCallAddTaskLinkAsyncWithCorrectParameters()
        {
            ...
            var expectedTask = new CuTask(
                Id: "testId",
                CustomId: null, CustomItemId: null, Name: "testName", TextContent: null, Description: null, MarkdownDescription: null,
            ...
            _mockTaskRelationshipsService.Setup(x => x.AddTaskLinkAsync(
                It.IsAny<string>(),
                It.IsAny<string>(),
                It.IsAny<AddTaskLinkRequest>(), // Updated to use DTO
            ...
            _mockTaskRelationshipsService.Verify(x => x.AddTaskLinkAsync(
                taskId,
                linksToTaskId,
                It.Is<AddTaskLinkRequest>(r => r.CustomTaskIds == customTaskIds && r.TeamId == teamId), // Verify DTO content
        ...
        public async Task AddAsync_ShouldCallAddTaskLinkAsyncWithOnlyRequiredParameters()
        {
            ...
            _mockTaskRelationshipsService.Verify(x => x.AddTaskLinkAsync(
                taskId,
                linksToTaskId,
                It.Is<AddTaskLinkRequest>(r => r.CustomTaskIds == null && r.TeamId == null), // Verify DTO content
                It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}

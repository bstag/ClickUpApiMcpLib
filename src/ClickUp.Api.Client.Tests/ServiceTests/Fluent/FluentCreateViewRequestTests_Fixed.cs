...
public class FluentCreateViewRequestTests_Fixed
{
    private readonly Mock<IViewsService> _mockViewsService;

    public FluentCreateViewRequestTests_Fixed()
    {
    ...
    public async Task CreateAsync_WorkspaceContainerType_ShouldCallCreateWorkspaceViewAsync()
    {
        ...
        var fluentRequest = new ViewFluentCreateRequest(containerId, _mockViewsService.Object, ViewFluentCreateRequest.ViewContainerType.Workspace)
            .WithName(name)
            .WithType(type)
    ...
    public async Task CreateAsync_SpaceContainerType_ShouldCallCreateSpaceViewAsync()
    {
        ...
        var fluentRequest = new ViewFluentCreateRequest(containerId, _mockViewsService.Object, ViewFluentCreateRequest.ViewContainerType.Space)
            .WithName(name)
            .WithType(type);
    ...
    public async Task CreateAsync_FolderContainerType_ShouldCallCreateFolderViewAsync()
    {
        ...
        var fluentRequest = new ViewFluentCreateRequest(containerId, _mockViewsService.Object, ViewFluentCreateRequest.ViewContainerType.Folder)
            .WithName(name)
            .WithType(type);
    ...
    public async Task CreateAsync_ListContainerType_ShouldCallCreateListViewAsync()
    {
        ...
        var fluentRequest = new ViewFluentCreateRequest(containerId, _mockViewsService.Object, ViewFluentCreateRequest.ViewContainerType.List)
            .WithName(name)
            .WithType(type);

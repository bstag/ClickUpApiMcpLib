...
public class FluentCreateUserGroupRequestTests
{
    ...
    public async Task CreateAsync_ShouldCallCreateUserGroupAsyncWithCorrectParameters()
    {
        ...
        var expectedUserGroup = new UserGroup("groupId", workspaceId, 1, name, handle ?? string.Empty, "dateCreated", null, new List<ClickUp.Api.Client.Models.Common.Member>(), null); // Mock a UserGroup object
        ...
        var fluentRequest = new FluentCreateUserGroupRequest(workspaceId, _mockUserGroupsService.Object)
            .WithName(name)
            .WithHandle(handle)
            .WithMembers(members);
    ...
    public async Task CreateAsync_ShouldCallCreateUserGroupAsyncWithOnlyRequiredParameters()
    {
        ...
        var workspaceId = "testWorkspaceId";
        var name = "testGroupName";
        var expectedUserGroup = new UserGroup("groupId", workspaceId, 1, name, null, "dateCreated", null, new List<ClickUp.Api.Client.Models.Common.Member>(), null); // Mock a UserGroup object

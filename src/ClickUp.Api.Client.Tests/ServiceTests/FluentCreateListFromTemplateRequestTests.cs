...
public class FluentCreateListFromTemplateRequestTests
{
    ...
    public async Task CreateAsync_InFolderTrue_ShouldCallCreateListFromTemplateInFolderAsync()
    {
        ...
        var fluentRequest = new FluentCreateListFromTemplateRequest(containerId, templateId, _mockListsService.Object, true)
            .WithName(name);
    ...
    public async Task CreateAsync_InFolderFalse_ShouldCallCreateListFromTemplateInSpaceAsync()
    {
        ...
        var fluentRequest = new FluentCreateListFromTemplateRequest(containerId, templateId, _mockListsService.Object, false)
            .WithName(name);

...
public class FluentSetCustomFieldValueRequest
{
    private readonly string _taskId;
    private readonly string _fieldId;
    private readonly ICustomFieldsService _customFieldsService;

    public FluentSetCustomFieldValueRequest(string taskId, string fieldId, ICustomFieldsService customFieldsService)
    {
        _taskId = taskId;
        _fieldId = fieldId;

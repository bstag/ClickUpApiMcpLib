...
public class FluentCreateChecklistRequest
{
    ...
    public FluentCreateChecklistRequest(string taskId, ITaskChecklistsService taskChecklistsService)
    {
        _taskId = taskId;
        _taskChecklistsService = taskChecklistsService;
    }

    public FluentCreateChecklistRequest WithName(string name)
    {
        _name = name;
        return this;
    }

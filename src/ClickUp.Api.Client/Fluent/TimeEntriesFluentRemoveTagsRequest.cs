...
public class TimeEntriesFluentRemoveTagsRequest
{
    ...
    public TimeEntriesFluentRemoveTagsRequest(string workspaceId, ITimeTrackingService timeTrackingService)
    {
        _workspaceId = workspaceId;
        _timeTrackingService = timeTrackingService;
    }

    public TimeEntriesFluentRemoveTagsRequest WithTimeEntryIds(List<string> timeEntryIds)
    {
        _timeEntryIds = timeEntryIds;
        return this;
    }

    public TimeEntriesFluentRemoveTagsRequest WithTags(List<string> tags)
    {
        _tags = tags;
        return this;
    }

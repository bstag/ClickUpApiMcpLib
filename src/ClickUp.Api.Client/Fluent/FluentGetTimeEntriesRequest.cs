...
public class FluentGetTimeEntriesRequest
{
    ...
    public FluentGetTimeEntriesRequest(string workspaceId, ITimeTrackingService timeTrackingService)
    {
        _workspaceId = workspaceId;
        _timeTrackingService = timeTrackingService;
    }

    public FluentGetTimeEntriesRequest WithStartDate(long startDate)
    {
        _startDate = startDate;
        return this;
    }

    public FluentGetTimeEntriesRequest WithEndDate(long endDate)
    {
        _endDate = endDate;
        return this;
    }

    public FluentGetTimeEntriesRequest WithAssignee(int assignee)
    {
        _assignee = assignee;
        return this;
    }

    public FluentGetTimeEntriesRequest WithTaskId(string taskId)
    {
        _taskId = taskId;
        return this;
    }

    public FluentGetTimeEntriesRequest WithCustomTaskIds(bool customTaskIds)
    {
        _customTaskIds = customTaskIds;
        return this;
    }

    public FluentGetTimeEntriesRequest WithTeamIdForCustomTaskIds(string teamIdForCustomTaskIds)
    {
        _teamIdForCustomTaskIds = teamIdForCustomTaskIds;
        return this;
    }

    public FluentGetTimeEntriesRequest WithIncludeTaskTags(bool includeTaskTags)
    {
        _includeTaskTags = includeTaskTags;
        return this;
    }

    public FluentGetTimeEntriesRequest WithIncludeLocationNames(bool includeLocationNames)
    {

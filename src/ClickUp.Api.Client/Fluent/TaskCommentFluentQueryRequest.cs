...
public class TaskCommentFluentQueryRequest
{
    private readonly GetTaskCommentsRequest _request;
    private readonly string _taskId;
    private readonly ICommentsService _commentsService;

    public TaskCommentFluentQueryRequest(string taskId, ICommentsService commentsService)
    {
        _taskId = taskId;
    ...
    public TaskCommentFluentQueryRequest WithCustomTaskIds(bool customTaskIds)
    {
        _request.CustomTaskIds = customTaskIds;
        return this;
    }

    public TaskCommentFluentQueryRequest WithTeamId(string teamId)
    {
        _request.TeamId = teamId;
        return this;
    }

    public TaskCommentFluentQueryRequest WithStart(long start)
    {

...
public class TasksFluentMergeRequest
{
    ...
    public TasksFluentMergeRequest(string targetTaskId, ITasksService tasksService)
    {
        _targetTaskId = targetTaskId;
        _tasksService = tasksService;
    }

    public TasksFluentMergeRequest WithSourceTaskIds(List<string> sourceTaskIds)
    {

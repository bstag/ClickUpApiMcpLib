...
public class FluentEditChecklistItemRequest
{
    ...
    public FluentEditChecklistItemRequest(string checklistId, string checklistItemId, ITaskChecklistsService taskChecklistsService)
    {
    ...
    public FluentEditChecklistItemRequest WithName(string name)
    {
        _name = name;
        return this;
    }

    public FluentEditChecklistItemRequest WithResolved(bool resolved)
    {
        _resolved = resolved;
        return this;
    }

    public FluentEditChecklistItemRequest WithAssignee(string assignee)
    {
        _assignee = assignee;
        return this;
    }

    public FluentEditChecklistItemRequest WithParent(string parent)
    {
        _parent = parent;
        return this;
    }

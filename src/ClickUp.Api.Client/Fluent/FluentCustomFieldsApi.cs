...
public class FluentCustomFieldsApi
{
    private readonly ICustomFieldsService _customFieldsService;

    public FluentCustomFieldsApi(ICustomFieldsService customFieldsService)
    {
    ...
    public FluentSetCustomFieldValueRequest SetCustomFieldValue(string taskId, string fieldId)
    {
        return new FluentSetCustomFieldValueRequest(taskId, fieldId, _customFieldsService);
    }

    

    public FluentRemoveCustomFieldValueRequest RemoveCustomFieldValue(string taskId, string fieldId)
    {
        return new FluentRemoveCustomFieldValueRequest(taskId, fieldId, _customFieldsService);
    }
}

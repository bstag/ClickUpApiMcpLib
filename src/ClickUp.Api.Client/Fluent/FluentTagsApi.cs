...
public class FluentTagsApi
{
    private readonly ITagsService _tagsService;

    public FluentTagsApi(ITagsService tagsService)
    {
    ...
    public FluentModifyTagRequest CreateSpaceTag(string spaceId)
    {
        return new FluentModifyTagRequest(spaceId, _tagsService);
    }

    public FluentModifyTagRequest EditSpaceTag(string spaceId, string tagName)
    {
        return new FluentModifyTagRequest(spaceId, _tagsService, tagName);
    }

...
public class FluentWebhooksApi
{
    private readonly IWebhooksService _webhooksService;

    public FluentWebhooksApi(IWebhooksService webhooksService)
    {
    ...
    public FluentCreateWebhookRequest CreateWebhook(string workspaceId)
    {
        return new FluentCreateWebhookRequest(workspaceId, _webhooksService);
    }

    public FluentUpdateWebhookRequest UpdateWebhook(string webhookId)
    {
        return new FluentUpdateWebhookRequest(webhookId, _webhooksService);
    }
